...
backpack_data %>% 
  ...
  theme_linedraw()
```
This bar chart shows the count of backpack weights for each weight and each gender, in weights where there is only one gender of observations the bars are double width. No obvsious difference between sex, other than extremely heav bags belong to males.
